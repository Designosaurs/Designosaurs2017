...
public abstract class DesignosaursOpMode extends OpMode {

    //------------------------------------------------------------------------------------------------
    // State
    //------------------------------------------------------------------------------------------------

    private DesignosaursOpModeHelper helper = null;
    ...
    final public void init() {
        ...
        this.helper = new DesignosaursOpModeHelper();
    ...
    /**
     * From the non-linear OpMode; do not override
     * fuck FIRST, I'll override your mom
     */
    @Override
    ...
    protected class DesignosaursOpModeHelper implements Runnable {

        protected RuntimeException exception = null;
        protected boolean isShutdown = false;

        public DesignosaursOpModeHelper() {
        }

        @Override
        public void run() {
            ThreadPool.logThreadLifeCycle("DesignosaursOpMode main", new Runnable() {
                @Override
                public void run() {
                    exception = null;
                    isShutdown = false;
                    ...
                    try {
                        DesignosaursOpMode.this.runOpMode();
                        requestOpModeStop();
                    } catch (InterruptedException ie) {
                        // InterruptedException, shutting down the op mode
                        RobotLog.d("DesignosaursOpMode received an InterruptedException; shutting down this linear op mode");
                        ...
                        // best choice.
                        RobotLog.d("DesignosaursOpMode received a CancellationException; shutting down this linear op mode");
